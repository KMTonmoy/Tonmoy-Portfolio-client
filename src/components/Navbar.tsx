        ...
        <div className="z-50 sticky shadow-2xl top-0 bg-[#1D1730] p-7">
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div className="hidden md:flex gap-8">
                    ...
                    {user ? (
                        <Link
                            ...
                            href='/dashboard'
                            className={`text-[16px] font-[400] transition-all duration-300 ${pathname === 'dashboard'
                                ? "text-[#F95353] underline underline-offset-4"
                                : "hover:text-[#F95353]"
                                }`}
                        >
                ...
                {user ? (
                    ...
                    <button onClick={() => logOut()} className="hidden md:block text-[16px] rounded-xl font-[400] bg-[#F95353] px-5 py-3 hover:bg-[#F95353]/90 transition-all duration-300">
                        Logout
                    </button>
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center gap-6">
                            ...
                            {user ? (
                                ...
                                <button onClick={() => logOut()} className="text-[16px] rounded-xl font-[400] bg-[#F95353] px-6 py-3 hover:bg-[#F95353]/90 transition-all duration-300">
                                    Logout
                                </button>
